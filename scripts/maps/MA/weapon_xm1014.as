...
const int XM1014_MAX_CLIP   	= 8;

const int XM1014_WEIGHT     	= 20;


const uint SHOTGUN_SINGLE_PELLETCOUNTER = 12;
...
g_SoundSystem.PrecacheSound( "weapons/cs16/xm1014-1.wav" );
 ...
 break;
		...
		self.m_flNextPrimaryAttack = WeaponTimeBase() + 0.20;
	...
	//Always uses a relative time due to prediction
...

		{
			...
			m_flNextReload 					= WeaponTimeBase() + 0.15;
			self.m_flNextPrimaryAttack 		= WeaponTimeBase() + 0.15;
			self.m_flTimeWeaponIdle 		= WeaponTimeBase() + 0.15;
