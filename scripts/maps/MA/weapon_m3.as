...
const Vector VECTOR_CONE_SHOTGUN( 0.09, 0.05, 0.00  );
// 10 degrees by 5 degrees


const int M3_DEFAULT_GIVE	= 30;

const int M3_MAX_CLIP   	= 15;
...
case 1:
		...
		m_pPlayer.FireBullets( 5, vecSrc, vecAiming, VECTOR_CONE_SHOTGUN, 2048, BULLET_PLAYER_CUSTOMDAMAGE, 0, m_iBulletDamage );
		...
		self.m_flNextPrimaryAttack = WeaponTimeBase() + 0.74;

		self.m_flNextSecondaryAttack = WeaponTimeBase() + 0.74;
...
Vector vecShellVelocity, vecShellOrigin;
	...
	//Always uses a relative time due to prediction
...

		{
			...
			self.m_flTimeWeaponIdle 		= WeaponTimeBase() + 0.3;
...

{
	...
	g_ItemRegistry.RegisterWeapon( GetM3Shotty(), "cs16", "buckshot" );
