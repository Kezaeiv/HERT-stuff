...
class weapon_tmp : ScriptBasePlayerWeaponEntity
{
	...
	void PrimaryAttack()
	{
		...
		self.m_flNextPrimaryAttack = WeaponTimeBase() + 0.04f;
	...
	void Reload()
	{
		...
		self.DefaultReload( TMP_MAX_CLIP, TMP_RELOAD, 1.68, 0 );
		BaseClass.Reload();
	}
...
void RegisterTMP()
{
	...
	g_ItemRegistry.RegisterWeapon( GetTMPName(), "cs16", "9mm" );
}