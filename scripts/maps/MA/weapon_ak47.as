...
const int AK47_DEFAULT_GIVE 	= 90;
...

{
	...
	void PrimaryAttack()
	{
		...
		//self.m_flNextPrimaryAttack = self.m_flNextPrimaryAttack + 0.1f;
	...
	void Reload()
	{
		...
		self.DefaultReload( AK47_MAX_CLIP, AK47_RELOAD, 1.9, 0 );
		BaseClass.Reload();
	}
...
void RegisterAK47()
{
	...
	g_ItemRegistry.RegisterWeapon( GetAK47Name(), "cs16", "ins2_5.45x39mm" );
}